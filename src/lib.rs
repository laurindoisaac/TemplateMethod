// src/lib.rs
/*
 * Core library for TemplateMethod
 */
...
#[derive(Debug)]
pub struct TemplateMethodProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TemplateMethodProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TemplateMethod processing");
    
    let mut processor = TemplateMethodProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TemplateMethodProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TemplateMethodProcessor::new(false);
